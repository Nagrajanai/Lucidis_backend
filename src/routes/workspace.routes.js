...
router.get('/:id', validateWorkspaceId, workspaceController.getWorkspaceById.bind(workspaceController));
router.put('/:id', requireRole(UserRole.APP_OWNER, UserRole.ACCOUNT_ADMIN), validateWorkspaceId, workspaceController.updateWorkspace.bind(workspaceController));
